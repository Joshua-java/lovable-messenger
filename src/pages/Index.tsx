      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 text-center py-16">
          ...
          <motion.div {...floatingAnim(0.5, 20)} className="flex flex-col sm:flex-row gap-3 mt-10">
            ...
            <Link to="/login">
              <Button size="lg" variant="outline" className="text-base px-8 rounded-full h-12 border-white/30 text-white hover:bg-white/10">
                Sign In
              </Button>
            </Link>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="group p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/10 hover:border-primary/30 hover:bg-white/15 transition-all duration-300"
              >
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4 group-hover:bg-primary/20 transition-colors">
                  <feature.icon className="w-6 h-6 text-primary" />
                </div>
                <h3 className="font-semibold text-white text-lg">{feature.title}</h3>
                <p className="text-sm text-white/60 mt-2 leading-relaxed">{feature.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
